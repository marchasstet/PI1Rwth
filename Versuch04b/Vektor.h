...
/**
 * \brief Vektor-class holds the values of a 3-dimensional vector
 */
class Vektor
{
   ...
   public:
       ...
       */
      Vektor* subtract(Vektor* v) const;
       ...
       */
      bool isOrthogonal(Vektor* v) const;
