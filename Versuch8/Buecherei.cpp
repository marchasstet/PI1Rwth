...
int main()
{
    ...
    do  // Anzeige des Men�s
    {
        std::cout << std::endl
                  ...
                  << "(7): Beenden" << std::endl
        		  << "(8): Ausgeliehende Medien ausgeben" << std::endl;
        ...
        switch (abfrage)
        {
            ...
            case'8':{
            	std::cout<<"Liste wird ausgegeben"<<std::endl;
...
////////////////////////////////////////////////////
/**
 * @brief Entfernt ein Medium anhand seiner ID aus der Liste.
 *
 * Diese Funktion ermöglicht es, ein Medium anhand seiner ID aus der Liste der Medien zu entfernen.
 * Die ID wird vom Benutzer eingegeben. Wenn die ID gefunden wird, wird das Medium gelöscht und aus der Liste entfernt,
 * andernfalls wird eine Fehlermeldung ausgegeben.
 *
 * @param[in] medien Ein Vektor von Zeigern auf Medienobjekte.
 */
void mediumEntfernen(std::vector<Medium*>& medien)
{
...
/////////////////////////////////////////////////////
/**
 * @brief Leiht ein Medium anhand seiner ID aus.
 *
 * Diese Funktion ermöglicht es, ein Medium anhand seiner ID an eine Person auszuleihen.
 * Die ID, der Name der Person und das Geburtsdatum der Person werden vom Benutzer eingegeben.
 * Wenn die ID gefunden wird, wird das Medium an die Person ausgeliehen,
 * andernfalls wird eine Fehlermeldung ausgegeben.
 *
 * @param[in] medien Ein Vektor von Zeigern auf Medienobjekte.
 * @param[in] aktuellesDatum Das aktuelle Datum, an dem das Medium ausgeliehen wird.
 */
void mediumAusleihen(std::vector<Medium*>& medien, Datum aktuellesDatum)
{
...
////////////////////////////////////////////////////
/**
 * @brief Gibt ein Medium anhand seiner ID zurück.
 *
 * Diese Funktion ermöglicht es, ein Medium anhand seiner ID als zurückgegeben zu markieren.
 * Die ID wird vom Benutzer eingegeben. Wenn die ID gefunden wird, wird das Medium zurückgegeben,
 * andernfalls wird eine Fehlermeldung ausgegeben.
 *
 * @param[in] medien Ein Vektor von Zeigern auf Medienobjekte.
 */
...
/**
 * @brief Gibt alle vorhandenen Medien aus einer Liste aus.
 *
 * Diese Funktion durchläuft eine Liste von Medien und gibt die Details aller Medien auf der Konsole aus.
 *
 * @param[in] medien Ein Vektor von Zeigern auf Medienobjekte.
 */
void alleMedienAusgeben(std::vector<Medium*>& medien)
...
//Ausgeben ausgeliehede Medien
/**
 * @brief Gibt alle ausgeliehenen Medien aus einer Liste aus.
 *
 * Diese Funktion durchläuft eine Liste von Medien und gibt die Details aller ausgeliehenen Medien auf der Konsole aus.
 * Falls keine Medien ausgeliehen sind, wird eine entsprechende Nachricht ausgegeben.
 *
 * @param[in] medien Ein Vektor von Zeigern auf Medienobjekte.
 */
void ausgeliehendeMedienAusgeben(std::vector<Medium*>& medien){
	bool leer=true;
	std::cout << " Medien Ausgeliehen:" << std::endl;
	    ...
	    if(leer==true){std::cout<<"Keine Medien Ausgeliehen"<<std::endl;}
}
